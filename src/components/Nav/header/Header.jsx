    ...
    <>
      <div className='header__div'>
        <figure className='header__figure'>
          <img className='figure__img' src="../../../../public/avatar.svg" alt="" />
        </figure>
        ...
        <div className='header__networks'>
          ...
          <a class="div__a" href="https://www.instagram.com/" target="_blank">
            <img src="../../../../public/Íconos/instagram.svg"alt="icono instagram" />
          </a>
          <a class="div__a" href="https://twitter.com/" target="_blank">
            <img src="../../../../public/Íconos/twitter.svg" alt="icono twitter" />
            </a>
        </div>
